        ...
        <footer className="bg-[#FDFBF7] pt-32 pb-12 px-6 border-t border-gray-200">
            <div className="max-w-[1400px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
                    ...
                    <div>
                        <h4 className="text-xs uppercase tracking-widest font-bold text-[#2C2C2C] mb-8">Demandes</h4>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mb-6 font-light">Rejoignez notre liste pour des opportunités exclusives hors marché.</p>
