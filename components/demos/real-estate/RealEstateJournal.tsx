            ...
            <div className="max-w-[1400px] mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-12">
                    <div className="max-w-2xl">
                        <MaskReveal>
                            <span className="text-[#C19A6B] text-[10px] uppercase tracking-[0.6em] font-bold mb-4 block">Le Journal Atlas</span>
                        </MaskReveal>
                        <MaskReveal delay={0.2}>
                            <h2 className="text-5xl md:text-8xl font-serif text-[#2C2C2C] leading-none">Perspective <br /><span className="italic">& Art de Vivre</span></h2>
                        </MaskReveal>
                    </div>
                    <MaskReveal delay={0.4}>
                        <p className="text-gray-400 text-[10px] uppercase tracking-[0.3em] font-bold pb-4 border-b border-gray-100 lg:w-96">
                            Exploration de l'intersection entre la tradition marocaine et le luxe architectural moderne.
                        </p>
                    </MaskReveal>
                </div>
                    ...
                    {articles.map((article, i) => (
                        ...
                        >
                            ...
                            <button className="text-[10px] uppercase tracking-[0.4em] font-bold text-gray-400 group-hover:text-[#2C2C2C] transition-colors flex items-center gap-4">
                                Lire la Perspective <div className="w-8 h-[1px] bg-gray-200 group-hover:bg-[#C19A6B] transition-colors" />
                            </button>
                        </motion.div>
                    ))}
                </div>
                ...
                <div className="mt-32 border-t border-gray-100 pt-20 flex justify-center">
                    <button className="group relative">
                        <span className="text-[12px] uppercase tracking-[0.6em] font-bold text-[#2C2C2C]">Voir Toutes les Perspectives</span>
                        <motion.div
